...
let-env config = {
	...
	color_config: {
		...
		shape_block: $blue
		shape_bool: $cyan
		shape_closure: $orange
		shape_custom: $green
		shape_datetime: $cyan
		shape_directory: $cyan
		shape_external: $green
		shape_externalarg: $base.fg
		shape_filepath: $cyan
		shape_flag: $blue
		shape_float: $violet
		shape_garbage: $red
	...
	menus: [
		...
		# Note the lack of source parameter
		{
			...
			style: {
				text: $base.fg
				selected_text: { fg: $base.fg_emph, bg: $base.bg_hl }
				description_text: $base.fg_muted
			}
		}
		{
			name: history_menu
